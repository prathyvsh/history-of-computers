...
Neat article that outlines how a search for mathematization of computer science evolved. The article draws to a close emphasizing that we are still far away from a good theoretical basis for computer science and that it might involve a new historical philosophical structure of mathematization.
